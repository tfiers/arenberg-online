...
urlpatterns = patterns('',
	...
	url(r'^musicians/tickets/?$', RedirectView.as_view(pattern_name='space_ticketing:musician_dashboard')),
	url(r'^musicians/?$', RedirectView.as_view(pattern_name='space_ticketing:musician_dashboard')),
