...
class UserAdmin(django.contrib.auth.admin.UserAdmin):
    ...
    fieldsets = (
        ...
        (_('Permissions'), {'fields': ('is_active', 'is_staff', 'is_superuser', 'approved',
    ...
    list_display = ('email', 'first_name', 'last_name', 'birthdate','study', 'phone_number', 'is_staff', 'approved', 'date_joined', 'last_login')
